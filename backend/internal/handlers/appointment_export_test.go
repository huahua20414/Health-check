...
func newAppointmentExportFixture(t *testing.T) (*Handler, *gorm.DB, appointmentExportFixture) {
	...
	fixture := appointmentExportFixture{
		...
		doctorAppointment: models.Appointment{ID: 30, OrderNo: "HCEXPORT001", UserID: 2, DoctorID: 4, InstitutionID: 10, PackageID: 20, AppointmentType: "个人体检", Category: "年度综合", Date: "2026-07-02", Period: "上午", StartTime: "09:00", EndTime: "09:30", Status: "booked", PaymentStatus: "paid", InvoiceTitle: "用户甲", InvoiceTaxNo: "TAX001", Note: "导出测试"},
		otherAppointment:  models.Appointment{ID: 31, OrderNo: "HCEXPORT002", UserID: 3, DoctorID: 5, InstitutionID: 10, PackageID: 21, AppointmentType: "复查体检", Category: "影像专项", Date: "2026-07-03", Period: "下午", StartTime: "14:00", EndTime: "14:30", Status: "reported", PaymentStatus: "unpaid"},
	}

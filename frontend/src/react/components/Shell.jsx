...
import { Bell, Calendar, ChevronDown, ChevronRight, ClipboardList, Database, FileText, Home, LogOut, RefreshCcw, Settings, ShieldCheck, User, Users } from 'lucide-react'
import { Button } from './UI.jsx'
import { useHealth } from '../HealthContext.jsx'

const iconMap = { Home, Database, Calendar, ClipboardList, FileText, User, Users, Bell, Settings, ShieldCheck }
...
export const menuItems = [
  ...
  { label: '系统管理', icon: 'Settings', roles: ['admin'], children: [
    { path: '/admin/operations', label: '运营管理', icon: 'Bell', roles: ['admin'] },
  ] },
]

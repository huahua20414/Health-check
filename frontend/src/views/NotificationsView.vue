...
const { notifications, activeAnnouncements, supportInfo, supportTickets, supportTicketForm, loading, paginations, loadAll, loadSupportTicketsPage, markNotificationRead, createSupportTicket } = useHealthData()

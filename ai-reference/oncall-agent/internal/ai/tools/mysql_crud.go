// Package tools 中的本文件实现 MySQL 增删改查工具，供 Agent 执行数据库操作。
package tools
...
func NewMysqlCrudTool() tool.InvokableTool {
	t, err := utils.InferOptionableTool(
		"mysql_crud",
		"Execute SQL queries against the MySQL database and"+
			" return results in JSON format. Use this tool when you need to query, "+
			"insert, update or delete data from the database. "+
			"The results will be formatted as JSON for easy parsing.",
